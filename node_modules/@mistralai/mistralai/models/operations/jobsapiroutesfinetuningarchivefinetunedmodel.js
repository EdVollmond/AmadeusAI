...
/** @internal */
exports.JobsApiRoutesFineTuningArchiveFineTunedModelRequest$inboundSchema = z
    .object({
    model_id: z.string(),
})
    .transform((v) => {
...
/** @internal */
exports.JobsApiRoutesFineTuningArchiveFineTunedModelRequest$outboundSchema = z
    .object({
    modelId: z.string(),
})
    .transform((v) => {
