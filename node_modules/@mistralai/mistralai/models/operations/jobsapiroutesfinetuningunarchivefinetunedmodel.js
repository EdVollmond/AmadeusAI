...
/** @internal */
exports.JobsApiRoutesFineTuningUnarchiveFineTunedModelRequest$inboundSchema = z
    .object({
    model_id: z.string(),
})
    .transform((v) => {
...
/** @internal */
exports.JobsApiRoutesFineTuningUnarchiveFineTunedModelRequest$outboundSchema = z
    .object({
    modelId: z.string(),
})
    .transform((v) => {
