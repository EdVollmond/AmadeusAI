...
const resolveEncodingAsync = async (encoding) => {
    switch (encoding) {
        ...
        case 'o200k_base':
            return (0, convertTokenBytePairEncodingFromTuples_js_1.convertTokenBytePairEncodingFromTuples)(await import('./encodings/o200k_base.js').then(({ default: encodingTuples }) => encodingTuples));
        default: {
