...
function getDeepInfraResponse(model, messages, baseUrl, apiKey, stream) {
...
function DeepInfraHandler(params) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const baseUrl = (_a = params.baseUrl) !== null && _a !== void 0 ? _a : 'https://api.deepinfra.com';
        const apiKey = (_b = params.apiKey) !== null && _b !== void 0 ? _b : process.env.DEEPINFRA_API_KEY;
        const model = params.model.split('deepinfra/')[1];
        const res = yield getDeepInfraResponse(model, params.messages, baseUrl, apiKey, (_c = params.stream) !== null && _c !== void 0 ? _c : false);
        if (params.stream) {
